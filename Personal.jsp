...
<main>
    ...
    <section class="contenedor">
        <div class="buscador-especialistas">
            ...
            <input type="text" id="buscarEspecialista" placeholder="Buscar por nombre, especialidad o sede...">
        </div>
    </section>
...
document.addEventListener("click", function(e){
    ...
    if(panel && campana && !panel.contains(e.target) && !campana.contains(e.target)){
